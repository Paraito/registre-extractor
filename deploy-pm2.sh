...
echo -e "${BLUE}============================================================================${NC}"
echo ""
echo -e "${GREEN}✅ Unified Workers:${NC} 9 workers (3 PM2 instances × 3 workers each)"
echo -e "   → Handles: Land Registry, REQ, RDPRM"
...
echo -e "  pm2 logs unified-worker     # View unified worker logs"
